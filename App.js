...
const Home = () => {
 const data = [
  {
   id: 1,
   subheading1: "Concert UI App",
   subheading2: "Mobile UI Project",
   img: require("./assets/images/porto1.png"),
  },
  {
   id: 2,
   subheading1: "Talk AI Web",
   subheading2: "Mobile UI Project",
 ...
 return (
  <ScrollView>
   <View style={styles.container}>
    ...
    />
    <Text style={styles.heading1}>Devrizal Maryuandi</Text>
    <Text style={styles.paragraph}>
     Hello, my name is Devrizal Maryuandi. Currently, I am studying at Telkom
     Purwokerto Vocational High School majoring in Software Engineering. I
     specialize in creating UI/UX Throughout
